...
<script type="text/ecmascript-6">
  ...
  export default{
    ...
    mounted(){
      let page=1;
      var _this=this;
      this.$http.get(interfaceStr+'/cc/blog/pageBlogs/getByCategoryId.action?rowCount=10&page='+page+'&categoryId=5').then(function (response) {
      ...
      $(window).scroll(function () {
        ...
        if (topCon >= loadOffset) {
          page++;
          _this.$http.get(interfaceStr + '/cc/blog/pageBlogs/getByCategoryId.action?rowCount=10&page=' + page + '&categoryId=5').then(function (response) {
