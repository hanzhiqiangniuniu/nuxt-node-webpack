<template>
  <div class="visa">
    ...
    <div class="visa-step">
      <div class="auto">
        <h2 class="visa-step-title">Get Your Legal Work Visa</h2>
        <i class="visa-line"></i>
        <ul class="step-tab" id="imgLazy">
          <li class="step-list clear">
            <div class="list-left">
              <i class="step-number step-number1"></i>
              <h3 class="list-title">Visa Document Preparation</h3>
              <p class="list-des">
          ...
          <li class="step-list clear">
            <div class="list-left">
              ...
              <h3 class="list-title">Chinese Work Visa Application</h3>
              <p class="list-des">
          ...
          <li class="step-list clear">
            <div class="list-left">
              <i class="step-number step-number5"></i>
              <h3 class="list-title">Receive Your China Resident Permit</h3>
              <p class="list-des">
          ...
          <li class="step-line3"></li>
          <li class="step-line4"></li>
        </ul>
      </div>
    </div>
    <div class="quesBox">
      ...
      <div class="whatIs clear">
        <div class="list_Box" id="list_Box">
          <!--<p class="prompt">
            ...
            factor to be admitted?
          </p>-->
          <ul class="quesTab" id="quesTab">
            <li class="quesList bg" id="Q11">
              <a href="javascript:;">
                Can I invite my friends/family members to China?
              </a>
            </li>
            <li class="quesList" id="Q22">
              <a href="javascript:;">
          ...
          <ul class="anTab" id="anTab">
            <li class="anList firstT an-active" id="A1">
              ...
              <p class="listP">
                ...
                <br/><br/>
                A. Invitation letter<br/><br/>
                B. Copy of your passport bio-page and residence permit<br/><br/>
                C. Reservation of air ticket<br/><br/>
...
<br/><br/>
                If you are going to live in a hotel:
                We need your address for the work permit application, you must stay in the same address during the whole process of the work permit application. It is about 3 weeks.
                Tell them you are going to use this as application document to apply for your visa, let them issue a standard form. The RFTR you get from hotel is different from hotel to hotel.
                <br/><br/>
                If you are going to live in a long term apartment:
                This kind of RFTR can be obtained at the Local Police Station in charge of the area of your apartment.
                <br/><br/>
...
<style scoped>
  ...
  .guideTab .guideList .guideIcon {
    ...
    width: 18px;
    height: 29px;
    background: url("../assets/img/service/icon-careeradvice-arrow-normal.png") no-repeat center;
    margin-top: 36.5px;
    cursor: pointer;
  }
