...
<script type="text/ecmascript-6">
  ...
  export default{
    ...
    head:{
      ...
      title:'work in China',
      meta:[
        { name: "keywords", content: "work in china"},
        { name: "description", content: "Learn what it's like to work in China."},
        { property: "og:url", content: 'www.careerchina.com/work-in-China'},
        { property: "og:type", content: "article"},
        { property: "og:image", content: "http://material.careerchina.com/img/db937695-36ef-4a0e-9ede-9e110b6a3de2.jpg"},
        { name: "twitter:card", content: "http://material.careerchina.com/img/db937695-36ef-4a0e-9ede-9e110b6a3de2.jpg"},
        { name: "twitter:creator", content: "careerchina"},
        { name: "twitter:image", content: "http://material.careerchina.com/img/db937695-36ef-4a0e-9ede-9e110b6a3de2.jpg"},
        { itemprop: "image", content: "http://material.careerchina.com/img/db937695-36ef-4a0e-9ede-9e110b6a3de2.jpg"},
      ]
    },
    components:{
      'v-nav':nav,
    ...
    mounted(){
      let page=1;
      var _this=this;
      this.$http.get(interfaceStr+'/cc/blog/pageBlogs/getByCategoryId.action?rowCount=10&page='+page+'&categoryId=3').then(function (response) {
      ...
      $(window).scroll(function () {
        ...
        if (topCon >= loadOffset) {
          page++;
          _this.$http.get(interfaceStr + '/cc/blog/pageBlogs/getByCategoryId.action?rowCount=10&page=' + page + '&categoryId=3').then(function (response) {
